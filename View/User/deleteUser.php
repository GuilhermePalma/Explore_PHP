...
<head>
    ...
    <title>Excluir do Usuario</title>
...
<div class="ui middle aligned center aligned grid">
    <div class="column">
        ...
        <h2 class="ui teal image header">Excluir Usuario</h2>
        ...
        <?php
            ...
            if(isset($_POST['email']) && isset($_POST['name'])){
                ...
                $userDAO = new UserDAO();
                $result_sql = $userDAO->DeleteUser($_POST['name'], $_POST['email']);

                if($result_sql == ""){
                    echo "<div class='ui positive message'>";
                    echo "Usuario <b>'".$_POST['name'].
                        "'</b> Excluido com Sucesso !".
                    "</div>";
                } else {
                    echo "<div class='ui error message'>";
                    echo "Não foi Possivel Excluir o Usuario <b>'"
                        .$_POST['name']."'</b>";
